from src.DataPreprocess.preprocess import DataProcessor , NormData
import cv2 
from src.DataPreprocess.draw_axice import Draw
from src.model.models import models
import numpy as np
import pandas as pd
from src.DataPreprocess.queue_1 import Queue
                            ...
                            if results.multi_face_landmarks != None:
                                for face in results.multi_face_landmarks:
                                    ...
                                    if smoothing  == True:
                                        ...
                                        Draw(frame,pred_pitch,pred_yaw,pred_roll,X[1],Y[1])
